            ...
            <div class="col-span-12 xl:col-span-12 xxl:col-span-12 z-10">
                <div class="mt-6 -mb-6 intro-y">
                    <div class="alert alert-dismissible show box bg-theme-25 text-white flex items-center mb-6" role="alert">
                        <span>
                            Selamat Datang di DYVe <strong>@antioch</strong> yang keren
                        </span>
                        ...
                        <table class="table table-report sm:mt-2">
                            <thead>
                                <tr>
                                    ...
                                    <th class="whitespace-nowrap">NAMA TEMPLATE</th>
                                    <th class="text-center whitespace-nowrap">RATING</th>
                                    <th class="text-center whitespace-nowrap">PEMILIK</th>
                            ...
                            <tbody>
                                    ...
                                    <td class="w-40">
                                        <div class="flex">
                                            <div class="w-10 h-10 image-fit zoom-in">
                                                <img alt="Tinker Tailwind HTML Admin Template" class="tooltip rounded-full" src="/assets/core/images/preview-9.jpg" title="Uploaded at 6 April 2022">
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <a href="" class="font-medium whitespace-nowrap">Qyua</a>
                                        <div class="text-gray-600 text-xs whitespace-nowrap mt-0.5">Template undangan pernikahan yang estetik</div>
                                    </td>
                                    <td class="text-center">4.5</td>
                                    <td class="w-40">
                                        <div class="flex items-center justify-center text-theme-20"> @veni_dack </div>
                                    </td>
                                ...
                                <tr class="intro-x">
                                    ...
                                    <td>
                                        <a href="" class="font-medium whitespace-nowrap">Deninw</a>
                                        <div class="text-gray-600 text-xs whitespace-nowrap mt-0.5">Template undangan ulang tahun yang estetik</div>
                                    </td>
                                    <td class="text-center">4.5</td>
                                    <td class="w-40">
                                        <div class="flex items-center justify-center text-theme-20"> @oni_chan </div>
                                    </td>
                                    <td class="table-report__action w-56">
                                        <div class="flex justify-center items-center">
                                            <a class="flex items-center mr-3" href=""> <i data-feather="check-square" class="w-4 h-4 mr-1"></i> Edit </a>
