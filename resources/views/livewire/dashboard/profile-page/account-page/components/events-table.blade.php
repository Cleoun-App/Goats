                    ...
                    <tbody>
                        @forelse ($events as $event)
                            <tr>
                                ...
                                <td class="border-b dark:border-dark-5">{{ $event->date }}</td>
                                <td class="border-b dark:border-dark-5">{{ $event->note ?? '-' }}</td>
                                ...
                                <td class="border-b dark:border-dark-5">
                                    <a class="btn btn-sm btn-primary" href="javacript:void(0)" data-toggle="modal"
                                        data-target="#delete-modal-{{ $event->id }}">Show
                                    </a>
                                </td>
                            </tr>
                                        ...
                                        <div class="modal-body p-0">
                                            ...
                                            <div class="px-5 pb-8 text-center">
                                                ...
                                                <button type="button" data-dismiss="modal" class="btn btn-danger w-24"
                                                    wire:click="deleteUser({{ $event->id }})">Hapus
                                                </button>
                                            </div>
                                        </div>
                                    </div>
