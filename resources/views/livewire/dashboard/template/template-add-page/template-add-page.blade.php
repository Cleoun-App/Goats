                        ...
                        <div id="content" class="tab-pane p-5 active" role="tabpanel" aria-labelledby="content-tab">
                            ...
                            <div class="border border-gray-200 dark:border-dark-5 rounded-md p-5 mt-5">
                                ...
                                <div class="mt-5">
                                    ...
                                    <div class="mt-2">
                                        <label for="cx" class="form-label">Copyright</label>
                                        <input id="cx" disabled type="text" class="form-control disabled" value="{{ $copyright }}">
                                    </div>
                                    @error('copyright')
                                    <div class="text-theme-21 mt-2">{{ $message }}</div>
                                    @enderror
            ...
            <div class="intro-y box p-5">
                    <div class="border-2 border-dashed shadow-sm border-gray-200 dark:border-dark-5 rounded-md p-5">
                        <div class="h-40 relative image-fit cursor-pointer zoom-in mx-auto">
                            @if($cover === null) 
                                <img class="rounded-md" alt="Tinker Tailwind HTML Admin Template" src="http://via.placeholder.com/640x360">
                            @else
