                ...
                <div class="dropdown-menu w-40">
                    <div class="dropdown-menu__content box dark:bg-dark-1 p-2">
                        <a href="#"
                            ...
                            <i data-feather="file-plus" class="w-4 h-4 mr-2"></i> Buat Pengguna Baru </a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="overflow-x-auto scrollbar-hidden">
            <div class="overflow-x-auto">
                <table class="table mt-5">
                    ...
                    <tbody>
                        @forelse ($users as $usx)
                            <tr>
                                <td class="border-b dark:border-dark-5">{{ $loop->index + 1 }}</td>
                                <td class="border-b dark:border-dark-5">{{ $usx->name }}</td>
                                <td class="border-b dark:border-dark-5">{{ $usx->username }}</td>
                                <td class="border-b dark:border-dark-5">{{ $usx->email }}</td>
                                <td class="border-b dark:border-dark-5">
                                    <a href="{{ route('ds.user.show', $usx->username) }}" class="btn btn-sm btn-primary mr-1">Visit</a >
                                        ...
                                        <div class="modal-body p-0">
                                            ...
                                            <div class="px-5 pb-8 text-center">
                                                ...
                                                <button type="button" data-dismiss="modal" class="btn btn-danger w-24"
                                                    wire:click="deleteUser({{ $usx->id }})">Hapus
                                                </button>
                                            </div>
                                        </div>
                                    </div>
            ...
            @component('components.pagination-table-navigator', ['nav' => $users])
            @endcomponent
