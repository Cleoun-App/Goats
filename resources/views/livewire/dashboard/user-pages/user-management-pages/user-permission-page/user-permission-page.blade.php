    ...
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        ...
        <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
            ...
            <div class="text-center">
                <a href="javascript:;" data-toggle="modal" data-target="#form-add-permission"
                    class="btn btn-primary">Tambahkan Permission
                </a>
                @livewire(
                    'dashboard.user-pages.user-management-pages.user-permission-page.components.form-dialog',
                    [
                        'id_modal' => 'form-add-permission',
                        'title' => 'Tambahkan Permission',
                    ],
                    key('1029192u9a0s')
                )
                            ...
                            <tr>
                                ...
                                <td class="border-b dark:border-dark-5">
                                    <a href="javascript:void(0);" data-toggle="modal"
                                        data-target="#edit-permission-{{ $loop->index }}"
                                            ...
                                            <div class="modal-body p-0">
                                                ...
                                                <div class="px-5 pb-8 text-center">
                                                    ...
                                                    <button type="button" data-dismiss="modal" class="btn btn-danger w-24"
                                                        wire:click="deletePermission({{ $usx->id }})">Hapus
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                @livewire(
                                    'dashboard.user-pages.user-management-pages.user-permission-page.components.form-dialog',
                                    [
                                        'id_modal' => 'edit-permission-' . $loop->index,
