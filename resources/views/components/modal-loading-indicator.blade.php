<div wire:loading.class.toggle="show" class="modal overflow-y-auto" data-backdrop="static" tabindex="-1"
aria-hidden="false" style="margin-top: 0px; margin-left: 0px; padding-left: 0px; z-index: 10000; position: fixed;">
<div class="modal-dialog modal-sm" style="height: 90%;display: flex;align-items: center; margin-top: 0;">
            ...
            <div class="text-center">
                <div class="mb-5">
                    <div class="col-span-6 sm:col-span-3 xl:col-span-2 flex flex-col justify-end items-center">
                        ...
                        <svg width="20" viewBox="0 0 105 105" xmlns="http://www.w3.org/2000/svg" fill="rgb(226, 232, 240)" class="w-8 h-8">
                            ...
                            <div class="text-center text-xs mt-5">Memuat Halaman</div>
                        </div>
                </div> 
